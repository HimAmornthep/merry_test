...
SELECT 
  ...
  Racial_Identity.racial_name AS racial_preference,  -- ใช้ racial_preference แทน racial_identity
...
JOIN Racial_Identity ON User_Profiles.racial_preference_id = Racial_Identity.racial_id  -- ใช้ racial_preference_id
